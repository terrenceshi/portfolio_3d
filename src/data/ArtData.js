const ArtData = [
    ...
    },
    {
        "title": "Get Out",
        "year": "2022",
        "description": "More facial geometric practice on the main character of Jordan Peele's 'Get Out'. I wanted to try a style of having sharp edges and clear geometric shapes for this facial study.",
        "images":
                [
                    require("../assets/art/get_out/wip6.png"), 
                    require("../assets/art/get_out/wip0.png"), 
    ...
    },
    {
        "title": "Split Face",
        "year": "2022",
        "description": "After my other projects this summer, I used my acquired skills in facial anatomy and geometric planes to make this painting from imagination, lighting and everything.",
        "images":
                [
                    require("../assets/art/parasyte/para.png"), 
                    require("../assets/art/parasyte/para1.png"), 
    ...
    },
    {
        "title": "Eren Yeager",
        "year": "2022",
        "description": "I wanted to make something Attack on Titan related since Season 4 aired. After a few other sketches, I settled on something Eren focused.",
        "images":
                [
                    require("../assets/art/eren/yeager.png"), 
                    require("../assets/art/eren/wip1.png"), 
    ...
    },
    {
        "title": "Homelander",
        "year": "2022",
        "description": "Simple drawing from a frame of the television series, The Boys. Testing out polygonal lasso style drawing trying to capture Anthony Starr's facial expression.",
        "images":
                [
                    require("../assets/art/hl/hl.png"), 
                    require("../assets/art/hl/wip1.png"), 
    ...
    },
    {
        "title": "3D Head",
        "year": "2021",
        "description": "I needed to get some practice modeling, rigging, and skinning the human face. This additionally helped my knowledge of anatomy. I chose Rami Malek as my base, as I had recently seen 'No Time to Die', and he is handsome.",
        "images":
                [
                    require("../assets/art/modelface/transformation.gif"), 
                    require("../assets/art/modelface/angry.jpg"), 
    ...
    },
    {
        "title": "Green Goblin",
        "year": "2021",
        "description": "Sketch of the green goblin. Made an effort to get his helmet's geometry accurate.",
        "images":
                [
    ...
    },
    {
        "title": "Hannibal",
        "year": "2021",
        "description": "Outline and hatching heavy style drawing of Hannibal Lector.",
        "images":
                [
    ...
    },
    {
        "title": "Price Heist",
        "year": "2020",
        "description": "I imagined and designed a fictional pirating software company as a project. Here's my card!",
        "images":
                [
    ...
    },
    {
        "title": "Portal",
        "year": "2020",
        "description": "Photoshop assignment for graphic design class.",
        "images":
                [
    ...
    },
    {
        ...
        "year": "2017",
        "description": "Funny cat drawing I made back in Graphic Design class. Used a mouse for the edges surprisingly.",
        "images":
                [
    ...
    },
    {
        "title": "Starlord",
        "year": "2017",
        "description": "Painting of Starlord back when Guardians of the Galaxy 2 came out.",
        "images":
                [
    ...
    },
    {
        "title": "Moira",
        "year": "2017",
        "description": "Digital sketch of Moira, the maid from Season 1 of American Horror Story.",
        "images":
                [
