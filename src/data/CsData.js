const CsData = [
    ...
    },
    {
        ...
        "description":
            [
                "Authorship Attribution is the task of guessing the author of an anonymous article. While this technology is interesting, it's important it is not abused.",
                "Our Neural Network was to diffrentiate between 260 Taylor Swift and Kanye West songs as well as 200 James Dashner and Rick Riordan excerpts.",
    ...
    },
    {
        ...
        "description":
            [
                ...
                "Many datasets were combined along with outliers from google images. I wrote the training code with PyTorch and based my model off of one of google's.",
